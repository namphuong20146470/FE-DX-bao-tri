// filepath: /C:/Users/Nam Phuong/Downloads/HOPT/FE-Bao-Tri/FE-Mainternance/src/components/home/Home.jsx
...
function Home() {
  ...
  // State để lưu danh sách giá trị duy nhất cho dropdown
  ...
  const fetchData = async () => {
    try {
      ...
      if (result.success) {
        ...
        // Trích xuất giá trị duy nhất cho các dropdown
